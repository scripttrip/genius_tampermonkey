...
// ==UserLibrary==
// @name         GeniusLyrics
// @description  Downloads and shows genius 
...
/*
    Copyright (C) 2019, mazz (mazz@openmail.cc) and contributors
...
if (typeof module !== 'undefined') {
  ...
  function geniusLyrics (custom) { // eslint-disable-line no-unused-vars
    ...
    const __SELECTION_CACHE_VERSION__ = 12
    const __REQUEST_CACHE_VERSION__ = 12
  ...
  Browser:    ${navigator.userAgent}
        ...
        <br>
        or via email: <a target="_blank" href="mailto:mazz@openmail.cc">mazz@openmail.cc</a>
        <br>
        <br>
  ...
  @font-face{font-family:'Programme';src:url(https://assets.genius.com/fonts/programme_light_italic.woff2?1671208854) format("woff2"),url(https://assets.genius.com/fonts/programme_light_italic.woff?1671208854) format("woff");font-style:italic;font-weight:100}
    ...
    function config () {
      ...
      'Copyright © 2019 ',
      ['a', { style: { 'font-size': '15px' } }, { attr: { href: 'mailto:mazz@openmail.cc' } }, 'mazz'
      ],
      ' and contributors.',
      ['br'],
